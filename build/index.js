...
var ReportingUser$1 = function (props) {
    ...
    return (React__default['default'].createElement("main", { className: "page-container " + classes.pageContentContainer },
        React__default['default'].createElement(Typography$1, { variant: "h2" }, t('user.title')),
        React__default['default'].createElement("p", null, "Overview user")));
};
...
var ReportingUser = reactRedux.connect(mapStateToProps$1, mapDispatchToProps$1)(ReportingUser$1);
...
var ReportingService$1 = function (props) {
    ...
    return (React__default['default'].createElement("main", { className: "page-container " + classes.pageContentContainer },
        React__default['default'].createElement("h1", null, t('service.title')),
        React__default['default'].createElement("p", null, "Overview services")));
};
...
var ReportingService = reactRedux.connect(mapStateToProps, mapDispatchToProps)(ReportingService$1);
