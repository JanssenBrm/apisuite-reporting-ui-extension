...
var Authenticated = function () { return (React__default['default'].createElement("div", { style: {
        minHeight: '100%',
        backgroundColor: 'burlywood',
        padding: '300px 16px 0 16px',
    } },
    React__default['default'].createElement("h1", null, "Authenticated extension page"),
    React__default['default'].createElement("p", null, "This page was dynamically added by an extensions and it is only visible to authenticated users."))); };
