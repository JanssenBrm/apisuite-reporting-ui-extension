...
import React, { useLayoutEffect, useEffect, useMemo, useContext, useReducer, useRef, useDebugValue, forwardRef, createElement, createContext } from 'react';
...
i18n.addResourceBundle('pt', EXT_NAME, ptPT);
...
var ReportingUser = function (_a) {
    ...
    return (React.createElement("main", { className: "page-container " + classes.pageContentContainer },
        ...
        React.createElement(JobList, { jobs: jobs })));
};
